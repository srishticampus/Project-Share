        ...
        <CardContent className="grid gap-4">
          {isEditMode ? (
            <form onSubmit={handleSubmit} className="grid gap-4">
              ...
              <div>
                <Label className="text-lg font-bold" htmlFor="areasOfExpertise">Areas of Expertise</Label>
                <Input type="text" id="areasOfExpertise" name="areasOfExpertise" value={editProfileData.areasOfExpertise || ''} onChange={handleChange} />
              </div>
              <div>
                <Label className="text-lg font-bold" htmlFor="yearsOfExperience">Years of Experience</Label>
            ...
            <>
              ...
              <div>
                ...
                <div className="flex gap-1">
                  {profileData.areasOfExpertise && profileData.areasOfExpertise.map((skill) => (
              ...
              <div>
                <Label className="text-lg font-bold" htmlFor="yearsOfExperience">Years of Experience</Label>
                <p className="text-gray-500">{profileData.yearsOfExperience}</p>
              </div>
              <div>
                <Label className="text-lg font-bold" htmlFor="credentials">Credentials</Label>
