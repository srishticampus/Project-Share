...
const AdminRegister = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:3000/api/auth/register/admin", { // Updated endpoint
        method: "POST",
        headers: {
      ...
      if (data.token) {
        ...
        // Redirect to admin dashboard after storing token
        ...
        // Or navigate to login page: navigate("/login/admin");
      }
    } catch (err) {
